...
_STREAMFRAMELOGSFORGATEWAYRESPONSE.fields_by_name['uplink_frame_set'].message_type = chirpstack__api_dot_gw_dot_gw__pb2._UPLINKFRAMESET
_STREAMFRAMELOGSFORGATEWAYRESPONSE.fields_by_name['downlink_frame'].message_type = chirpstack__api_dot_gw_dot_gw__pb2._DOWNLINKFRAME
...
_STREAMFRAMELOGSFORDEVICERESPONSE.fields_by_name['uplink_frame_set'].message_type = chirpstack__api_dot_gw_dot_gw__pb2._UPLINKFRAMESET
_STREAMFRAMELOGSFORDEVICERESPONSE.fields_by_name['downlink_frame'].message_type = chirpstack__api_dot_gw_dot_gw__pb2._DOWNLINKFRAME
