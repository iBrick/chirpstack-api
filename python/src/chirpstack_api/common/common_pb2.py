...
_LOCATIONSOURCE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GEO_RESOLVER', index=3, number=3,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
